...
- When not all the modules are released, then change line 52 in `release.sh` temporarily 
  so that it only contains the changed modules that will be released. Otherwise, unchanged
