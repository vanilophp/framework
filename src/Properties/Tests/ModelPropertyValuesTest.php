...
use Vanilo\Properties\Tests\Factories\PropertyValueFactory;

class ModelPropertyValuesTest extends TestCase
{
    #[Test] public function it_can_be_assigned_to_an_arbitrary_model()
    {
        $product = Product::create([
            'name' => 'Turbine Kreuzberg'
        ]);

        $haha = PropertyValueFactory::new()->create([
            'value' => 'haha'
        ]);

        $sixteen = PropertyValueFactory::new()->create([
            'property_id' => PropertyFactory::new()->create(['type' => 'integer'])->id,
            'value' => 16
        ]);
    ...
    #[Test] public function value_of_a_property_can_be_returned_by_property_slug()
    {
        $lamp = Product::create([
            'name' => 'Bicycle Lamp'
        ]);

        $color = PropertyFactory::new()->create(['name' => 'Color']);
    ...
    #[Test] public function value_of_a_property_returns_null_if_the_property_is_not_assigned()
    {
        $flex = Product::create([
            'name' => 'Bosch PWS 750-115 Angle Grinder'
        ]);

        PropertyValueFactory::new()->create([
            'value' => 'green',
            'property_id' => PropertyFactory::new()->create(['name' => 'Color'])->id,
        ]);

        $this->assertNull($flex->valueOfProperty('color'));
    }

    #[Test] public function value_of_a_property_returns_null_if_the_property_does_not_exist()
    {
    ...
    #[Test] public function a_value_can_be_assigned_to_a_model_by_property_and_scalar_value_when_the_property_value_exists()
    {
        $cake = Product::create(['name' => 'Kiwi Cake']);

        $color = PropertyFactory::new()->create(['name' => 'Color']);
        $taste = PropertyFactory::new()->create(['name' => 'Taste']);
    ...
    #[Test] public function a_non_existent_value_will_be_created_when_assigned_to_a_model_by_scalar_value()
    {
    ...
    #[Test] public function multiple_values_can_be_assigned_to_a_model_by_scalar_value()
    {
        $sword = Product::create(['name' => 'Sword']);
        PropertyFactory::new()->create(['name' => 'Length']);
        PropertyFactory::new()->create(['name' => 'Shape']);
    ...
    #[Test] public function multiple_entries_can_be_replaced_by_scalar_key_value_pairs_at_once()
    {
    ...
    #[Test] public function replace_by_scalar_will_create_new_values_if_necessary()
    {
    ...
    #[Test] public function attempting_to_assign_values_with_inexistent_properties_throws_an_exception()
    {
