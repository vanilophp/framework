...
class PropertyTest extends TestCase
{
    ...
    #[Test] public function autogenerated_slugs_are_unique()
    {
        $p1 = Property::create([
            'name' => 'RAM Size',
            'type' => 'text'
    ...
    #[Test] public function it_can_be_retrieved_by_slug_using_the_static_finder_method()
    {
        Property::create([
            'name' => 'RAM Size',
            'slug' => 'ram',
    ...
    #[Test] public function the_hidden_scopes_can_be_used_to_query_models()
    {
        for ($i = 0; $i < 8; $i++) {
            Property::create([
