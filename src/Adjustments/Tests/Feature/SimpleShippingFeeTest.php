...
{
    #[Test] public function a_simple_shipping_fee_can_be_added_to_an_adjustable_order()
    {
    ...
    #[Test] public function its_value_is_the_configured_amount_if_the_order_items_total_is_lower_than_the_threshold()
    {
    ...
    #[Test] public function its_value_is_zero_if_the_order_items_total_is_greater_than_the_threshold()
    {
