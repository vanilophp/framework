...
class ChannelConfigTest extends TestCase
{
    ...
    #[Test] public function configuration_entries_can_be_obtained_with_the_getter_method()
    {
    ...
    #[Test] public function configuration_entries_can_be_obtained_with_the_dot_notation()
    {
    ...
    #[Test] public function configuration_getter_returns_the_default_if_there_is_no_such_entry()
    {
    ...
    #[Test] public function configuration_getter_returns_null_if_no_default_was_given_and_the_key_doesnt_exist()
    {
    ...
    #[Test] public function the_configuration_can_be_set_with_the_setter_method()
    {
    ...
    #[Test] public function the_configuration_setter_preserves_existing_keys()
    {
