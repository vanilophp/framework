...
{
    #[Test] public function the_cart_facade_returns_a_nonexistent_cart_by_default()
    {
        $this->assertTrue(Cart::doesNotExist());
        $this->assertNull(Cart::model());
    }

    #[Test] public function item_count_is_zero_for_nonexistent_carts()
    {
        $this->assertEquals(0, Cart::itemCount());
    }

    #[Test] public function cart_reports_is_empty_for_nonexistent_carts()
    {
        $this->assertTrue(Cart::isEmpty());
    }

    #[Test] public function cart_id_in_session_without_db_entry_returns_proper_empty_values()
    {
