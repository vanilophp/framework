...
{
    /** @test */
    public function the_price_field_is_null_by_default()
    {
    ...
    /** @test */
    public function the_price_field_is_a_float_if_it_has_a_value()
    {
    ...
    /** @test */
    public function the_original_price_field_is_null_by_default()
    {
    ...
    /** @test */
    public function the_original_price_field_is_a_float_if_it_has_a_value()
    {
