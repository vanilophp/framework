...
[![Tests](https://img.shields.io/github/actions/workflow/status/vanilophp/payment/tests.yml?branch=5.x&style=flat-square)](https://github.com/vanilophp/payment/actions?query=workflow%3Atests)
