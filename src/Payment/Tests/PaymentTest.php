...
class PaymentTest extends TestCase
{
    ...
    #[Test] public function it_implements_the_payment_contract()
    {
        $this->assertInstanceOf(PaymentContract::class, new Payment());
    }

    #[Test] public function status_field_is_an_enum()
    {
        $payment = new Payment();
    ...
    #[Test] public function status_implements_the_payment_status_contract()
    {
        $payment = new Payment();
    ...
    #[Test] public function payment_has_default_status_if_none_was_given()
    {
        $payment = new Payment();
    ...
    #[Test] public function amount_paid_is_zero_by_default()
    {
        $payment = Payment::create([
            'amount' => 27,
            'currency' => 'EUR',
    ...
    #[Test] public function basic_fields_can_be_assigned()
    {
        $payment = Payment::create([
            'amount' => 27,
            'amount_paid' => 21,
    ...
    #[Test] public function it_can_resolve_the_related_payable_entity()
    {
        $order = Order::create([
            'id' => 2592,
            'total' => 35
    ...
    #[Test] public function the_related_payment_method_can_be_retrieved()
    {
        $payment = Payment::create([
            'amount' => 35,
            'currency' => 'EUR',
    ...
    #[Test] public function the_interface_getter_methods_return_the_appropriate_attributes()
    {
        $order = Order::create([
            'total' => 41
        ]);
    ...
    #[Test] public function payment_hash_gets_automatically_generated()
    {
        $payment = new Payment();
    ...
    #[Test] public function the_payment_hash_is_21_chars_by_default()
    {
        $payment = new Payment();
    ...
    #[Test] public function autogenerated_hashes_are_unique()
    {
        $numbers = [];
    ...
    #[Test] public function the_hash_can_be_explicitly_set()
    {
        $payment = new Payment([
    ...
    #[Test] public function the_hash_can_be_explicitly_set_when_using_the_static_creator()
    {
        $payment = Payment::create([
            'amount' => 27,
            'currency' => 'EUR',
    ...
    #[Test] public function get_payment_id_returns_the_hash()
    {
        $payment = new Payment([
            'hash' => 'sunshine'
        ]);
    ...
    #[Test] public function payments_can_be_located_by_hash_with_the_static_finder_method()
    {
        $payment = Payment::create([
            'amount' => 27,
            'currency' => 'EUR',
    ...
    #[Test] public function the_static_finder_returns_null_if_no_item_was_found()
    {
        $this->assertNull(Payment::findByPaymentId('I do not exist'));
    }

    #[Test] public function extra_data_is_an_array()
    {
        $payment = new Payment();
    ...
    #[Test] public function extra_data_can_be_set_as_array()
    {
        $payment = Payment::create([
            'amount' => 27,
            'currency' => 'EUR',
