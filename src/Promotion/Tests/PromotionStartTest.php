...
{
    #[Test] public function it_has_not_started_if_the_start_date_is_in_the_future()
    {
        $this->assertFalse((new Promotion(['starts_at' => Carbon::now()->addDay()]))->hasStarted());
    }

    #[Test] public function it_has_started_if_the_start_date_is_null()
    {
        $this->assertTrue((new Promotion())->hasStarted());
    }

    #[Test] public function it_has_started_if_the_start_date_is_now()
    {
        $this->assertTrue((new Promotion(['starts_at' => new \DateTime()]))->hasStarted());
    }

    #[Test] public function it_has_started_if_the_start_date_is_in_the_past()
    {
        $this->assertTrue((new Promotion(['starts_at' => Carbon::yesterday()]))->hasStarted());
    }

    #[Test] public function it_can_tell_if_it_will_be_started_at_a_future_date()
    {
    ...
    #[Test] public function it_can_tell_if_it_was_started_at_a_past_date()
    {
