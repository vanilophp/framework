...
{
    #[Test] public function a_shipping_method_has_no_shipping_category_by_default()
    {
    ...
    #[Test] public function a_shipping_method_can_have_a_shipping_category()
    {
    ...
    #[Test] public function shipping_category_matching_condition_is_none_by_default()
    {
        $method = ShippingMethod::create(['name' => 'Canada Post'])->fresh();

        $this->assertInstanceOf(ShippingCategoryMatchingConditionContract::class, $method->shipping_category_matching_condition);
        $this->assertEquals(ShippingCategoryMatchingCondition::UNUSED(), $method->shipping_category_matching_condition);
        $this->assertTrue($method->shipping_category_matching_condition->is_unused);
        $this->assertTrue($method->shipping_category_matching_condition->isUnused());
    }

    #[Test] public function a_shipping_method_can_be_assigned_a_shipping_category_matching_condition()
    {
